...
@Component({
  selector: 'app-constructor-stamps6',
  templateUrl: './constructor-stamps6.component.html',
  styleUrls: ['./constructor-stamps6.component.scss']
})
export class ConstructorStamps6Component implements OnInit {

  @ViewChild('step2') private _step2: ElementRef;

  // Configuration for edit for 6 stamps
  readonly constructorConfig: IConstructorConfig = {
    'type': 'stamps-6',
    'totalStamps': 6,
    'costPerPage': 25000, // the price is in kopecks
    'costPerItem': '12.00',
    'stamp': {
      // resolution - size in pixels of cropped image. Argument - side length in millimeters
      'resolution': {
        'width': this.setResolution(33),
        'height': this.setResolution(30)
      },
  ...
  public fileBtnConfig: IImagesToFill = {
    ...
    'imageNumber': [1,2,3,4,5,6] // Array of images to fill
  };
